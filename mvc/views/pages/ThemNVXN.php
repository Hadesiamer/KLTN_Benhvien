<div class="card">
    <div class="card-header">
        <h3>Thêm Nhân viên xét nghiệm mới</h3>
    </div>
    <div class="card-body">
        ...
        <form action="./ThemNVXN" method="POST">
            <div class="mb-3">
            ...
            <div class="text-center mt-3">
                <button type="submit" class="btn btn-success" name="btnThemNVXN">Thêm Nhân viên</button>
            </div>
        </form>
    </div>
</div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        const form = document.querySelector('form[action="./ThemNVXN"]');
