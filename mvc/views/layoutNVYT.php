                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="list-group">
                                <a href="/KLTN_Benhvien/NVYT"><button class="tab_btn" id="a">Xử lý hóa đơn</button></a>
                                <a href="/KLTN_Benhvien/NVYT/LichKham"><button class="tab_btn" id="a">Sửa lịch khám</button></a>
                            </div>
                        </div>
                    </div>
                </div>
