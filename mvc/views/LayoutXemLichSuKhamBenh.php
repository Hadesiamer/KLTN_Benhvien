    ...
    <div class="layout">
        <div class="sidebar">
            ...
            <ul class="function-list">
                ...
                <li><a href="/KLTN_Benhvien/Bacsi/XemLichSuKhamBenh" class="active">Xem lịch sử khám bệnh</a></li>
            </ul>
        </div>
        ...
        <div class="main-content">
            ...
            <form method="POST" action="/KLTN_Benhvien/Bacsi/XemLichSuKhamBenh" class="search-bar">
